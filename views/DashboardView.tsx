    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="pb-6">
      ...
      <div className="relative w-full h-[85vh] md:h-[700px] overflow-hidden mb-8">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center pointer-events-none">
          <motion.h2 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6, duration: 1.2, ease: "easeOut" }} className="font-handwritten text-4xl md:text-7xl text-white drop-shadow-2xl">
            Bo Ty, zasługujesz na więcej...
          </motion.h2>
        </div>
        <div className="absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-[#F9FAFB] to-transparent pointer-events-none" />
      </div>
